...
import com.zon.wanandroid.manager.ImageLoaderManager;
...
import com.zon.wanandroid.ui.adapter.ArticleListAdapter;
import com.zon.wanandroid.ui.base.BaseFragment;
import com.zon.wanandroid.ui.base.BasePresenter;
import com.zon.wanandroid.ui.presenter.HomePresenter;
...
//设置轮播图
        ...
        mBannerView.setAdapter(new BGABanner.Adapter<View,BannerBean>() {
            ...
            public void fillBannerItem(BGABanner banner, View itemView, BannerBean model, int position) {
                ...
                ImageLoaderManager.LoadImage(getActivity(), model.getImagePath(), imageView);
            }
        });
        mBannerView.setDelegate(new BGABanner.Delegate<View,BannerBean>() {
            ...
            public void onBannerItemClick(BGABanner banner, View itemView, BannerBean model, int position) {
                WebViewActivity.runActivity(getActivity(), model.getUrl());
            }
        });
    }
